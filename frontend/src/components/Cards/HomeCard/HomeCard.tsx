...
export default function HomeCard({ imageSrc, videoSrc, title, isZoomed, link }: HomeCardProps) {
  return (
    <main className="relative flex flex-col items-center w-auto h-auto lg:w-[375px] lg:h-[370px] lg:mb-28 lg:mt-14 font-poppins group">
      <div
        className={`relative flex justify-center w-auto h-auto lg:w-[375px] ${
          isZoomed
